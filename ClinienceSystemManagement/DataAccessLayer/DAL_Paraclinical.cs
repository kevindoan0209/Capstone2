...
namespace DataAccessLayer
{
    ...
    {
        public int InsertParaclinical(string name, string id, double valueMin, double valueMax, string anotherName, string unit, string category, string link, string note, string description, string referenceValue, int groupId)
        {
        ...
        public int UpdateParaclinical(string name, string id, double valueMin, double valueMax, string anotherName, string unit, string category, string link, string note, string description, string referenceValue, int groupId)
        {
