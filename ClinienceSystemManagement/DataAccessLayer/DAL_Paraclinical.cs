...
namespace DataAccessLayer
{
    ...
    {
        public int Insert(string name, string id, int valueMin, int valueMax, string anotherName, string unit, string category, string link, string note, string description, string referenceValue, int groupId)
        {
        ...
        public int Update(string name, string id, int valueMin, int valueMax, string anotherName, string unit, string category, string link, string note, string description, string referenceValue, int groupId)
        {
